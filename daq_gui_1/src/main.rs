...
impl eframe::App for MyApp {
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        let my_frame = egui::containers::Frame {
            ...
            shadow: eframe::epaint::Shadow { extrusion: 0.0, color: egui::Color32::YELLOW },
            fill: egui::Color32::LIGHT_GRAY,
            stroke: egui::Stroke::new(0.0, egui::Color32::GOLD),
        };

        egui::CentralPanel::default().frame(my_frame).show(ctx, |ui| {
            //ui.heading("DAQ GUI");
            ui.label(egui::RichText::new("DAQ GUI").heading().color(egui::Color32::BLACK));
                        ...
                        ui.vertical(|ui| { // now this is the left side vertical container, we'll have sensor selection on top, placeholder on bottom
                            ...
                            egui::Frame::none() // put a frame around the section
                                ...
                                .show(ui, |ui| {
                                    ...
                                    ui.label(egui::RichText::new("Select Sensors:").heading().color(egui::Color32::BLACK));
...
*/
                            ...
                            egui::Frame::none() // put a frame around the section
                                ...
                                .outer_margin(OUTER_MARGIN) // give some space around contents
                                .show(ui, |ui| {
                                    ui.label(egui::RichText::new("Configuration").heading().color(egui::Color32::BLACK));
                                    ui.add_space(15.0);

                                    ui.label(egui::RichText::new("Save data for...").color(egui::Color32::BLACK));
                                    ...
                                    ui.add_space(15.0); // pixels between content
                                    ui.horizontal(|ui| {
                                        ui.label(egui::RichText::new("data display frame:").color(egui::Color32::BLACK));
                            ...
                            ui.allocate_ui(
                                ...
                                |ui| {
                                    egui::Frame::none()
                                        ...
                                        .outer_margin(OUTER_MARGIN) // give some space around contents
                                        .show(ui, |ui| {
                                            ui.label(egui::RichText::new("ADC Sensor Data").color(egui::Color32::BLACK));
                        ...
                        if self.gps_selected { // Render GPS sensor block if selected
                            ui.allocate_ui(
                                ...
                                |ui| {
                                    ...
                                    .show(ui, |ui| {
                                        ui.label(egui::RichText::new("GPS Sensor Data").color(egui::Color32::BLACK));
                            ...
                            ui.allocate_ui(
                                ...
                                |ui| {
                                    egui::Frame::none()
                                        ...
                                        .outer_margin(OUTER_MARGIN) 
                                        .show(ui, |ui| {
                                            ui.label(egui::RichText::new("Mikroe Sensor Data").color(egui::Color32::BLACK));
